...
const ArticlePres=({articledata})=>{
    return (
    <div>
      <header className="header header-inverse h-fullscreen pb-80" style={{backgroundImage: `url(${articledata.image_url})`}} data-overlay={8}>
    <div className="container text-center">
      <div className="row h-full">
        <div className="col-12 col-lg-8 offset-lg-2 align-self-center">
          <p className="opacity-70">{articledata.Category}</p>
          <br />
          ...
          <p>
            ...
            <a className="text-white" href="#">{articledata.Created_by}</a>
          </p>
          <p>
